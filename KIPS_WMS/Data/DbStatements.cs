namespace KIPS_WMS.Data
{
    public static class DbStatements
    {
        ...
        public const string FindCustomersStatementNoName = "SELECT * FROM Customers Where Customer_code LIKE '%{0}%' OR Customer_name LIKE '%{0}%'";
        public const string FindItemsStatementBarcode = "SELECT * FROM Items Where Item_barcode = '{0}'";
        public const string FindItemsStatementNoDescription = "SELECT * FROM Items Where Item_code LIKE '%{0}%' OR Item_description LIKE '%{0}%'";
    }
}
