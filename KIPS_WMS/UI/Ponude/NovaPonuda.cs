...
namespace KIPS_WMS.UI.Ponude
{
    public partial class NovaPonuda : Form
    {
        ...
        {
            new PonudaKorpa(Utils.UnknownCustomerCode, "NEPOZNATO FIZ. LICE", 0, String.Empty, new List<ItemQuoteModel>()).Show();
            Close();
        }
        ...
        private void NovaPonuda_KeyPress(object sender, KeyPressEventArgs e)
        {
